...
Ты далеко не {isBoy(): любитель | любительница} рано просыпаться
...
Я: Зашибись! # злость # Effect character_shake
...
Location: {isBoy() : Комната М | Комната Д}
...
Обучение. Ваши выборы влияют на дальнейшее развитие сюжета. Выбирайте с умом!
Я: Ну... 
    * [Нет, с чего бы?]
        ->Conflict01
...
Ты {isBoy(): вспомнил | вспомнила} то странное сообщение!
Интересно, что там?
...
Мама: Глазам не верю! # удивление # Effect character_shake
...
Мама: Какой ты у меня молодец, всё сделал!
Похоже она очень оценила мои старания.
